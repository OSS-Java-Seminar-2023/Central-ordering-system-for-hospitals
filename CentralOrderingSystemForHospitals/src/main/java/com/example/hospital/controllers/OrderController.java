...
public class OrderController {
    ...
    {
        order.setDoctorOfGeneralMedicine((User) session.getAttribute("user"));
    ...
    @GetMapping("/myPatientsGeneralMedicine")
    ...
    @GetMapping("/patient")
    public String getOrdersForPatient(HttpSession session, Model model) {
